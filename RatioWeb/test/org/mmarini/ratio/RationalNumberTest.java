...
/**
 * @author US00852
 * @version $Id: RationalNumberTest.java,v 1.3 2007/01/09 22:11:33 marco Exp $
 */
public class RationalNumberTest extends TestCase {
	...
	public final void testCompare() {
		...
		assertEquals(-1, number1.compareTo(number3));
	}

	public final void testAbsolute() {
		assertEquals(new RationalNumber(1,2), number1.absolute());
		assertEquals(new RationalNumber(2,3), number4.absolute());
	}
